...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/15 11:30:22 by asuissa           #+#    #+#             */
/*   Updated: 2018/02/15 11:41:08 by asuissa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		pf_ft_initialize_specs_suite(t_spec *specs)
{
	...
	specs[14].c = 'b';
	specs[14].ptr = &pf_ft_handler_b;
	specs[15].c = 'n';
	specs[15].ptr = &pf_ft_handler_n;
	specs[16].c = 'm';
	specs[16].ptr = &pf_ft_handler_m;
	specs[17].c = 'w';
	specs[17].ptr = &pf_ft_handler_w;
	specs[18].c = 0;
	specs[18].ptr = NULL;
}
